/****************************************************************************
** Meta object code from reading C++ file 'loginbusiness.h'
**
...
#error "The header file 'loginbusiness.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 14, 6), // "report"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 3), // "str"
QT_MOC_LITERAL(4, 26, 11) // "onReadyRead"

    },
    "LoginBusiness\0report\0\0str\0onReadyRead"
};
...
void LoginBusiness::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        LoginBusiness *_t = static_cast<LoginBusiness *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (LoginBusiness::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LoginBusiness::report)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject LoginBusiness::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_LoginBusiness.data,
      qt_meta_data_LoginBusiness,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *LoginBusiness::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LoginBusiness.stringdata0))
        return static_cast<void*>(const_cast< LoginBusiness*>(this));
...
// SIGNAL 0
void LoginBusiness::report(const QString & _t1)
{
